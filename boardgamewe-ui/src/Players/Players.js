...
class Players extends React.Component {
        ...
        render() {
            ...
            let empty_players = ( < div style = {
                { width: "100%" } } > < Typography > No player found < /Typography></div > );
            ...
            return ( <
                ...
                message = { < span id = "error_msg" > Error
                    while fetching the players < /span>}
                    action = {
                        [ <
                            IconButton
                            key = "close"
...

                    {
                        this.state.players.length > 0 ?
                            ...
                            TableRow >
                            <
                            TableCell > Name < /TableCell> { /*<TableCell>Played</TableCell>*/ } <
                            /TableRow> <
                            /TableHead> <
                            TableBody > {
                                this.state.players.map(column => {
                                    return ( <
                                        ...
                                        { column.name } <
                                        /TableCell> { /*<TableCell numeric>*/ } { /*2*/ } { /*</TableCell>*/ } <
                                        /TableRow>
                                    );
                                }, this)
                            }
