...
import AddGame from "../Boardgames/AddGame/AddBoardGameModal";
...
class LibraryLayout extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            order: 'alphabetical',
            n_cols: LibraryLayout.get_number_of_columns_from_width(window.innerWidth),
    ...
    handleWindowSizeChange = () => {
        this.setState({n_cols: LibraryLayout.get_number_of_columns_from_width(window.innerWidth)})
    };
...
export default withStyles(styles)(LibraryLayout);
