...
class AddGame extends React.Component {
        ...
        handleRemoveScore(p_score) {
            ...
            this.setState({
                scores: current_scores.filter(function(_score) {
        ...
        handleRemoveWinLose(p_score) {
            ...
            this.setState({
                win_lose_scores: current_scores.filter(function(_score) {
                        ...
                        message = { < span id = "error_msg" > Error
                            ...
                            message = { < span id = "error_msg" > No board game selected < /span>}
                                ...
                                message = { < span id = "error_msg" > No score added < /span>}
                                    ...
                                    { /*<div className={classes.downshift}>*/ } { /**/ } { /*</div>*/ } <
                                    br / >
                                    <
                                    ...
                                    Downshift
                                    onChange = {
                                        (item) => this.handleChange(item, 'selected_board_game') }
                                    itemToString = {
                                        item => {
                                            if (!item) return "";
                                    ...
                                    Downshift
                                    onChange = {
                                        (item) => this.handleChange(item, 'selected_player') }
                                    itemToString = {
                                        item => {
                                            if (!item) return "";
                                            if (!item.hasOwnProperty("name")) return "";
                                            ...
                                            TableBody > {
                                                this.state.scores.map(p_score => {
                                                    return ( <
                                                        ...
                                                        color = "inherit"
                                                        onClick = {
                                                            () => this.handleRemoveScore(p_score) }
                                                        size = { "small" } >
                                                        <
                                                        CloseIcon / >
                                                        <
                                                        ...
                                                        scope = "row" > { p_score.player.name } <
                                                        /TableCell> <
                                                        TableCell > { p_score.score } <
                                                        /TableCell> <
                                                        /TableRow>
                                                    )
                                                })
                                            ...
                                            TableBody > {
                                                this.state.win_lose_scores.map(p_score => {
                                                    return ( <
                                                        ...
                                                        color = "inherit"
                                                        onClick = {
                                                            () => this.handleRemoveWinLose(p_score) }
                                                        size = { "small" } >
                                                        <
                                                        CloseIcon / >
                                                        <
